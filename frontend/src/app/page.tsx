      ...
      <section className="hero" style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="hero-body" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className="net-badge" title={`Connected to BOT Chain ${NETWORK_LABEL}`}>
            ...
            <span>Live on BOT Chain</span>
          </div>

          <div className="hero-eyebrow">Autonomous Agent Economy · BOT Chain · x402</div>
          ...
          <p className="hero-lead">
            ...
            on-chain, and settle every job in <strong>{SETTLEMENT_SYMBOL}</strong> — across the BOT Chain network.
          </p>
          ...
          <div className="hero-ticker">
            ...
            <div className="hero-stat">
              ...
              <span className="hero-stat-value">BOT Chain</span>
            </div>
            <div className="hero-stat">
